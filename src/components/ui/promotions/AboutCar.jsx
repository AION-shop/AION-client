...
const FeatureCard = ({ icon: Icon, title, value, description, delay }) => {
  ...
  return (
    <div className={`bg-white shadow-lg p-6 rounded-3xl border border-gray-200 transition-all duration-700 hover:scale-105 hover:shadow-2xl ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
...
const SpecItem = ({ label, value, icon: Icon }) => (
  <div className="flex items-center gap-3 p-4 bg-white shadow-md rounded-2xl hover:shadow-xl transition-all">
      ...
      <div className="container mx-auto px-4 py-12 space-y-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            <img src={car.images?.[1] || car.images?.[0] || ""} alt="Brake system" className="rounded-3xl shadow-lg w-full h-72 md:h-full object-cover" />
          </div>
        </div>
